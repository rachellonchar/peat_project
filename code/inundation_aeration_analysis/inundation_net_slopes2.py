...
from inundation_aeration_period_definitions2 import *
...
def slope_at_thresholds(thresholds_array=[-5,10,14.1,25],Xvar='period of aeration',Yvar='CH4',color='NTs10',col_map='coolwarm',
...
slope_at_thresholds(thresholds_array=[0.89,0],Xvar=xx,Yvar=yy,color=co,deviations_predictor='Ts10',
    deviations_applied_to='y',mask_events='inundated',pic_name='old_A2l',save_or_show='save')#,col_map='Blues')
#slope_at_thresholds(thresholds_array=[-0.48,0],Xvar=xx,Yvar=yy,color=co,
    #deviations_applied_to='y',mask_events='aerated',pic_name='old_I2l',save_or_show='save')#,col_map='Blues')
plt.show()
