...
def expected_CH4(Tsoil='NTs10',CH4='NCH4_S1',fit_type=btf.func_exp,dic=v,naming_dic=n,mask=None):
    ...
    Tsil,dd,nd = notation_fix(Tsoil,dic=dic,naming_dic=naming_dic,ret_dics=1)
    Csil = notation_fix(CH4,dic=dd,naming_dic=nd)
...
#expected_CH4('Ts10','CH4')
#general_fit_pre('NTs10','CH4',fit_type=btf.func_exp)
...
def deviations_from_fit(X,Y,fit_type=btf.func_linear,mask=None):
    ...
    return dev
#deviations_from_fit('Ts10','CH4',fit_type=btf.func_exp)
